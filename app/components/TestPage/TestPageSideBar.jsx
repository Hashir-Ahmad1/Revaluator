      ...
      <div className='flex flex-col w-full lg:w-3/4' style={{border:'1px solid #EC9521', backgroundColor:'#F9F9F8', borderRadius:'13px', width: '95%', maxWidth: '1200px', height: '97%'}}>
          <div className='p-8'>
           <div className='mb-3 flex dummyQuestionss-center'>
             <p className='text-base font-medium mr-2'>Q. # {dummyQuestions[selectedQuestion -1].questionNo}</p>
             <p className='text-base font-medium'>{dummyQuestions[selectedQuestion -1].questionStatement}</p>
           ...
           <div className=" p-2 mb-1">
             {/*option A*/}
               <div className='mt-1 flex dummyQuestionss-center'>
                 ...
                 <div className='text-base'>{dummyQuestions[selectedQuestion -1].optionA}</div>
               </div>
               {/*option B*/}
               <div  className='mt-2 flex dummyQuestionss-center'>
                 <input type="radio" name="" id="" className='mr-2'/>
                 <div className='text-base'>{dummyQuestions[selectedQuestion -1].optionB}</div>
               </div>
             
                 {/*option C*/}
                 <div className='mt-2 flex dummyQuestionss-center'>
                   <input type="radio" name="" id="" className='mr-2'/>
                   <div className='text-base'>{dummyQuestions[selectedQuestion -1].optionC}</div>
                 </div>

                 {/*option D*/}
                 <div className='mt-2 flex dummyQuestionss-center'>
                   <input type="radio" name="" id="" className='mr-2'/>
                   <div className='text-base'>{dummyQuestions[selectedQuestion -1].optionD}</div>
                 </div>
